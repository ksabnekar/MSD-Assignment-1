...
from django.forms import TextInput, DateTimeField
...
class ClientUpdateView(LoginRequiredMixin,UpdateView):
    model = Client
    fields = ('name', 'notes', 'address', 'city', 'state', 'zipcode', 'email', 'cell_phone', 'acct_number', 'created_date')
...
class ClientCreateView(LoginRequiredMixin,  CreateView):
    ...
    created_date = DateTimeField(
        widget=TextInput(attrs={'class': 'date-picker'}))
    fields = ('name', 'notes', 'address', 'city', 'state', 'zipcode', 'email', 'cell_phone', 'acct_number', 'created_date')
    login_url = 'login'
